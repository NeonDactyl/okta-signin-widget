...
const Body = BaseFormWithPolling.extend(Object.assign(
  {
    ...
    initialize() {
      ...
      if ((this.isOV() || this.isCustomApp()) &&
        !this.isAutoChallengeMissingFromRemediation()) {
    ...
    render() {
      ...
      if (this.isAutoChallengeMissingFromRemediation()) {
    ...
    isAutoChallengeMissingFromRemediation() {
